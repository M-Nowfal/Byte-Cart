...
const SellerDashboard = () => {
  ...
  if (products.length === 0) {
    return (
      <div className="min-h-150 p-8 flex flex-col justify-center items-center">
        <div className="text-center">
          ...
          <button className="btn btn-primary my-3" onClick={() => router.push("/seller/addproduct")}>Add Product</button>
        </div>
      </div>
    );
  }
